...
class LiDARDepthVisualizer:
    ...
    def create_distance_histogram(self, bins=50, figsize=(10, 6), save_path=None):
        ...
        ax.hist(valid_distances, bins=bins, alpha=0.7, color='skyblue', edgecolor='black')
    ...
    def create_all_plots(self, output_dir="lidar_plots"):
        ...
        self.create_2d_depth_plot('xy', save_path=f"{output_dir}/depth_plot_xy.png")
        plt.show()
        
        self.create_2d_depth_plot('xz', save_path=f"{output_dir}/depth_plot_xz.png")
        plt.show()
        
        self.create_2d_depth_plot('yz', save_path=f"{output_dir}/depth_plot_yz.png")
        plt.show()
        ...
        # Histogram
        self.create_distance_histogram(save_path=f"{output_dir}/distance_histogram.png")
        plt.show()
